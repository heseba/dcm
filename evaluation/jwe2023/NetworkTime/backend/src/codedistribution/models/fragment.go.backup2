...
type Fragment struct {
	...
	FragName  string `yaml:"fragment_name"`
...
//RawFragments, used before preprocessingtype RawYaml struct {
type RawYaml struct {
	Fragments RawFragments `yaml:"fragments"`
}
type RawFragments []RawFragment
